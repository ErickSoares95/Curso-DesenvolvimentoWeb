...
function createOrEdit() {
    ...
    // Enviar para API
    fetch(`https://63127d26f5cba498da9368fc.mockapi.io/api/projects${screenType === 'edit' ? ('/' + params.id) : ''}`, {
...
function fillInputs() {
    if (screenType === 'edit') {
        fetch(`https://63127d26f5cba498da9368fc.mockapi.io/api/projects/${params.id}`)
            .then(response => response.json())
            .then(project => {
